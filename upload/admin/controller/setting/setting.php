...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		foreach ($data['fields'] as $pole) {
			if (isset($this->request->post['config_admin_'.$pole.'_hide'])) {
				$data['config_admin_'.$pole.'_hide'] = $this->request->post['config_admin_'.$pole.'_hide'];
			} else {
				$data['config_admin_'.$pole.'_hide'] = $this->config->get('config_admin_'.$pole.'_hide');
			}
		}
